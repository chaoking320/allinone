...
import allinone.vi.host.DefaultEnHost;
import allinone.vi.utils.IOUtils;
import allinone.vi.utils.IPUtil;
...
//                                    + indexHtml.substring(menuIndex+pattern.length());
                            ...
                            indexHtml = indexHtml.substring(0,menuIndex) + "$SMENU = " + menuStr +
                                    ";$CIP='"+new DefaultEnHost().getHostAddress()+"';$CHOSTNAME='"+new DefaultEnHost().getHostName()+"';"+
                                    "$VERSION='java-0.11.2';"+
                                    (portalUrl!=null?"$PORTALURL='"+portalUrl+"';":"")
//                                    + "$ISLINUX="+ HostInfo.isLinux()+";$ISTOMCAT="+HostInfo.isTomcat()+";"
                                    + indexHtml.substring(menuIndex+pattern.length());
    ...
    private String menuStr = "[{\"EMPTYSTATE\":\"empty\",\"name\":\"Component\",\"state\":\"Component\",\"icon\":\"fa-codepen\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"Metrics\",\"state\":\"Dashboard\",\"icon\":\"fa-tachometer\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"Analyzer\",\"state\":\"empty\",\"icon\":\"fa-coffee\",\"isBuildIn\":true,\"submenu\":[{\"name\":\"Self Check\",\"state\":\"Analyzer-SelfCheck\",\"isBuildIn\":true},{\"name\":\"Jar dependency\",\"state\":\"Analyzer-Jardependency\",\"isBuildIn\":true},{\"name\":\"JVM Sampler\",\"state\":\"Analyzer-JVMSampler\",\"isBuildIn\":true},{\"name\":\"VisualGC\",\"state\":\"Analyzer-VisualGC\",\"isBuildIn\":true},{\"name\":\"GCLogAnalyzer\",\"state\":\"Analyzer-GCLogAnalyzer\",\"isBuildIn\":true}]},{\"EMPTYSTATE\":\"empty\",\"name\":\"Debug\",\"state\":\"Code\",\"icon\":\"fa-bug\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"Configuration\",\"state\":\"Configuration\",\"icon\":\"fa-cogs\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"FC\",\"state\":\"FC\",\"icon\":\"fa-toggle-on\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"Cache Manager\",\"state\":\"Cache\",\"icon\":\"fa-database\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"Thread dump\",\"state\":\"ThreadDump\",\"icon\":\"fa-camera\",\"isBuildIn\":true},{\"EMPTYSTATE\":\"empty\",\"name\":\"File log\",\"state\":\"Log\",\"icon\":\"fa-file\",\"isBuildIn\":true}]";
